...
class SliverProductsGridBl extends StatelessWidget {
  const SliverProductsGridBl({super.key, this.onPressed});
    ...
    return BlocBuilder<ProductsCubit, ProductsState>(
      builder: (context, state) {
        return SliverProductsAlignedGrid(
          itemCount: state.products?.length ?? 0, // products.length,
          itemBuilder: (_, index) {
